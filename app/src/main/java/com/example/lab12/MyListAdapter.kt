...
class MyListAdapter(private val context: Activity, private val rest_name: Array<String?>, private val address: Array<String?>,
                    private val distance: Array<String?>,private val access: Array<String?>)
    : ArrayAdapter<String>(context, R.layout.activity_near_rest,rest_name) {

    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        val inflater = context.layoutInflater
        val rowView = inflater.inflate(R.layout.activity_near_rest, null, true)
